...
try{
  ...
  //Reads the .tags file
	...
	cout<<cnt<<" frames processed, "<<cntrot<<" tag timepoints rotated, "<<cntdel<<" removed (0 detections)."<<endl;
	cout<<"false positives: "<<ctr<<endl;
	cout<<cdead<<" tag timepoints declared dead (i.e. not detected anymore) "<<endl;
